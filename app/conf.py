...
class Configuration:
    ...
    def __init__(self):
        ...
        if "notifiers" in user_config:
            self.notifiers = {
                **default_config["notifiers"],
                **user_config["notifiers"],
            }
        else:
        ...
        if "informants" in user_config:
            self.informants = {
                **default_config["informants"],
                **user_config["informants"],
            }
        else:
        ...
        if "crossovers" in user_config:
            self.crossovers = {
                **default_config["crossovers"],
                **user_config["crossovers"],
            }
        else:
